  ...
  render() {
    ...
    return (
      <div className='my-3'>
        ...
        <div className={`card-body bg-${mode === 'light' ? 'light' : 'dark'} text-${mode === 'light' ? 'dark' : 'light'}`} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
